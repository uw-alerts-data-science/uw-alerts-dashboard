...
@patch("scraper.batch_history.upsert_alert", return_value={"status": "inserted", "incident_id": 1, "alert_id": 1})
...
@patch("scraper.batch_history.psycopg2.connect")
def test_run_batch_returns_1_when_all_errors_no_inserts(mock_pg, mock_discover, mock_worker):
    mock_pg.return_value.cursor.return_value.__enter__.return_value.fetchall.return_value = []
    from scraper.batch_history import run_batch
